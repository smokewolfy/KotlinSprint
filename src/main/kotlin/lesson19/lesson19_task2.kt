...
enum class ProductCategory {
    CLOTHES {
        override fun categoryName() = "Одежда"
    },
    STATIONERY {
        override fun categoryName() = "Канцелярские товары"
    },
    OVER {
        override fun categoryName() = "Разное"
    };
    ...
    override fun toString(): String {
        return "Товар: $name\nID: $id\nКатегория: ${
            when (categoryName) {
                ...
                else -> ProductCategory.OVER.categoryName()
            }
        }\n"
    }
}
...
fun main() {
    ...
    val dogFood = Product("Собачий корм", 3, ProductCategory.OVER)
